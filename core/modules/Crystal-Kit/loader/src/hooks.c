...
DECLSPEC_IMPORT HINTERNET WINAPI WININET$InternetConnectA(HINTERNET, LPCSTR,
                                                          INTERNET_PORT, LPCSTR,
                                                          LPCSTR, DWORD, DWORD,
                                                          DWORD_PTR);
DECLSPEC_IMPORT HINTERNET WINAPI WININET$InternetOpenA(LPCSTR, DWORD, LPCSTR,
                                                       LPCSTR, DWORD);
DECLSPEC_IMPORT SOCKET WINAPI WS2_32$WSASocketA(int, int, int,
                                                LPWSAPROTOCOL_INFOA, GROUP,
                                                DWORD);
...
DECLSPEC_IMPORT BOOL WINAPI KERNEL32$DuplicateHandle(HANDLE, HANDLE, HANDLE,
                                                     LPHANDLE, DWORD, BOOL,
                                                     DWORD);
DECLSPEC_IMPORT BOOL WINAPI KERNEL32$GetThreadContext(HANDLE, LPCONTEXT);
DECLSPEC_IMPORT HMODULE WINAPI KERNEL32$LoadLibraryA(LPCSTR);
DECLSPEC_IMPORT LPVOID WINAPI KERNEL32$MapViewOfFile(HANDLE, DWORD, DWORD,
                                                     DWORD, SIZE_T);
DECLSPEC_IMPORT HANDLE WINAPI KERNEL32$OpenProcess(DWORD, BOOL, DWORD);
DECLSPEC_IMPORT HANDLE WINAPI KERNEL32$OpenThread(DWORD, BOOL, DWORD);
DECLSPEC_IMPORT BOOL WINAPI KERNEL32$ReadProcessMemory(HANDLE, LPCVOID, LPVOID,
                                                       SIZE_T, SIZE_T *);
...
DECLSPEC_IMPORT LPVOID WINAPI KERNEL32$VirtualAlloc(LPVOID, SIZE_T, DWORD,
                                                    DWORD);
DECLSPEC_IMPORT LPVOID WINAPI KERNEL32$VirtualAllocEx(HANDLE, LPVOID, SIZE_T,
                                                      DWORD, DWORD);
DECLSPEC_IMPORT BOOL WINAPI KERNEL32$VirtualFree(LPVOID, SIZE_T, DWORD);
DECLSPEC_IMPORT BOOL WINAPI KERNEL32$VirtualProtect(LPVOID, SIZE_T, DWORD,
                                                    PDWORD);
DECLSPEC_IMPORT BOOL WINAPI KERNEL32$VirtualProtectEx(HANDLE, LPVOID, SIZE_T,
                                                      DWORD, PDWORD);
DECLSPEC_IMPORT SIZE_T WINAPI KERNEL32$VirtualQuery(LPCVOID,
                                                    PMEMORY_BASIC_INFORMATION,
                                                    SIZE_T);
DECLSPEC_IMPORT BOOL WINAPI KERNEL32$WriteProcessMemory(HANDLE, LPVOID, LPCVOID,
                                                        SIZE_T, SIZE_T *);
DECLSPEC_IMPORT void WINAPI KERNEL32$ExitProcess(UINT);
DECLSPEC_IMPORT HRESULT WINAPI OLE32$CoCreateInstance(REFCLSID, LPUNKNOWN,
                                                      DWORD, REFIID, LPVOID *);
DECLSPEC_IMPORT ULONG NTAPI NTDLL$NtContinue(CONTEXT *, BOOLEAN);

BOOL WINAPI _HttpSendRequestA(HINTERNET hRequest, LPCSTR lpszHeaders,
...
HINTERNET WINAPI _InternetOpenA(LPCSTR lpszAgent, DWORD dwAccessType,
...
HINTERNET WINAPI _InternetConnectA(HINTERNET hInternet, LPCSTR lpszServerName,
...
SOCKET WINAPI _WSASocketA(int af, int type, int protocol,
...
HANDLE WINAPI _CreateFileMappingA(HANDLE hFile,
...
BOOL WINAPI _CreateProcessA(LPCSTR lpApplicationName, LPSTR lpCommandLine,
...
HANDLE WINAPI _CreateRemoteThread(HANDLE hProcess,
                                  LPSECURITY_ATTRIBUTES lpThreadAttributes,
                                  SIZE_T dwStackSize,
...
BOOL WINAPI _DuplicateHandle(HANDLE hSourceProcessHandle, HANDLE hSourceHandle,
...
LPVOID WINAPI _MapViewOfFile(HANDLE hFileMappingObject, DWORD dwDesiredAccess,
...
HANDLE WINAPI _OpenProcess(DWORD dwDesiredAccess, BOOL bInheritHandle,
                           DWORD dwProcessId) {
  FUNCTION_CALL call = {0};
...
HANDLE WINAPI _OpenThread(DWORD dwDesiredAccess, BOOL bInheritHandle,
                          DWORD dwThreadId) {
  FUNCTION_CALL call = {0};
...
BOOL WINAPI _ReadProcessMemory(HANDLE hProcess, LPCVOID lpBaseAddress,
...
LPVOID WINAPI _VirtualAllocEx(HANDLE hProcess, LPVOID lpAddress, SIZE_T dwSize,
                              DWORD flAllocationType, DWORD flProtect) {
  FUNCTION_CALL call = {0};
...
BOOL WINAPI _VirtualProtectEx(HANDLE hProcess, LPVOID lpAddress, SIZE_T dwSize,
...
SIZE_T WINAPI _VirtualQuery(LPCVOID lpAddress,
...
BOOL WINAPI _WriteProcessMemory(HANDLE hProcess, LPVOID lpBaseAddress,
...
void WINAPI _ExitProcess(UINT uExitCode) {
  ...
  call.ptr = (PVOID)(KERNEL32$ExitProcess);
  call.argc = 1;

  call.args[0] = spoof_arg(uExitCode);
