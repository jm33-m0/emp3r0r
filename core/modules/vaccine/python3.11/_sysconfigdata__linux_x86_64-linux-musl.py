...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '-Os -Wformat -Werror=format-security -g -O2 '
                            '-DTHREAD_STACK_SIZE=0x200000 '
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,--as-needed,-O1,--sort-common '
 ...
 'CONFIG_ARGS': "'--build=x86_64-alpine-linux-musl' "
                ...
                "'host_alias=x86_64-alpine-linux-musl' 'CC=gcc'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/buildozer/aports/main/python3/src/Python-3.11.4/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/buildozer/aports/main/python3/src/Python-3.11.4/lcov-report',
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -Os -Wformat '
                    '-Werror=format-security -g -O2 '
                    '-DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition '
                    '-flto -fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden -Os -Wformat -Werror=format-security '
                    '-g -O2 -DTHREAD_STACK_SIZE=0x200000 -fprofile-use '
 ...
 'LIBMPDEC_CFLAGS': '-DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -Wsign-compare '
                    '-DNDEBUG -g -fwrapv -O3 -Wall -Os -Wformat '
                    '-Werror=format-security -g -O2 '
                    '-DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition '
                    '-flto -fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g -std=c11 -Wextra '
 ...
 'LIBPL': '/usr/lib/python3.11/config-3.11-x86_64-linux-musl',
 'LIBPYTHON': '',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -Os '
                             ...
                             '-Wstrict-prototypes '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden -Os -Wformat '
                             '-Werror=format-security -g -O2 '
                             '-DTHREAD_STACK_SIZE=0x200000 -fprofile-use '
 ...
 'PY_CFLAGS_NODIST': '-Os -Wformat -Werror=format-security -g -O2 '
                     '-DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition '
                     '-flto -fuse-linker-plugin -ffat-lto-objects '
                     '-flto-partition=none -g -std=c11 -Wextra '
                     '-Wno-unused-parameter -Wno-missing-field-initializers '
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -Os -Wformat '
                   '-Werror=format-security -g -O2 '
                   '-DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition '
                   '-flto -fuse-linker-plugin -ffat-lto-objects '
                   '-flto-partition=none -g -std=c11 -Wextra '
 ...
 'PY_CORE_LDFLAGS': '-Wl,--as-needed,-O1,--sort-common '
                    '-Wl,-z,pack-relative-relocs -fno-semantic-interposition '
                    '-flto -fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g -Wl,--as-needed,-O1,--sort-common '
                    '-Wl,-z,pack-relative-relocs',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '',
 'PY_LDFLAGS_NODIST': '-Wl,--as-needed,-O1,--sort-common '
                      '-Wl,-z,pack-relative-relocs -fno-semantic-interposition '
                      '-flto -fuse-linker-plugin -ffat-lto-objects '
                      '-flto-partition=none -g '
                      '-Wl,--as-needed,-O1,--sort-common '
                      '-Wl,-z,pack-relative-relocs',
 'PY_LDFLAGS_NOLTO': '-fno-lto -Wl,--as-needed,-O1,--sort-common '
                     '-Wl,-z,pack-relative-relocs',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.11.4',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.11.4 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.11.4 '
 ...
 'abs_builddir': '/home/buildozer/aports/main/python3/src/Python-3.11.4',
 'abs_srcdir': '/home/buildozer/aports/main/python3/src/Python-3.11.4',
