...
A BOF tool that can be used to show (detailed) information from all processes running on the system and provides a summary of installed security products and tools.
...
4. Use Cobal Strike script manager to import the `Psx.cna` script.
...
* `psx`
* `psxx` (show more process details)
