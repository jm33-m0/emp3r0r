...
/**
 * Compute Adler-32 checksum of `length` bytes of data at `data`.
 *
 * @param start checksum of previous data (0 for first call)
...
/**
 * Compute CRC32 checksum of `length` bytes of data at `data`.
 *
 * @param start checksum of previous data (0 for first call)
 * @param data pointer to data
 * @param length size of data
