...
// Adapted from: https://github.com/BishopFox/sliver/blob/b7c8cba630ca3c27bd28367c9450482633b8127e/server/generate/donut.go
...
// - arch: the architecture of the PE file (x32, x64, x84)
// - dotnet: whether the PE file is a .NET assembly
// - params: the parameters to pass to the assembly
// - className: the class name of the assembly
// - method: the method to execute in the assembly
